...
\begin{textblock*}{128mm}(45mm,\seitenanfang + 62mm) % 4,5cm vom linken Rand und 6,0cm vom oberen Rand
  ...
  \textbf{Modeling Virtual Environments for Robot\\Experiments and Automation of Data\\ Generation and Augmentation for Object Recognition with Neural Networks}
  %\textbf{\hsmatitel}
\end{textblock*}%
