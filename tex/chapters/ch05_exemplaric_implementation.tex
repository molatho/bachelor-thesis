...
\captionof{figure}{Unity Technology's "Book of the Dead" promotional video video\cite{UnityDemoRealtimeTeaser}}
...
\begin{center}
\noindent\includegraphics[width=12cm]{tex/img/ch05/UnitySceneA205_02.png}
...
\captionof{figure}{A door that shows mutated opening angle, color, light-reflection, normal-map and smoothness}
...
\subsection{Evaluation: Viewer-Application}

\begin{center}
\noindent\includegraphics[width=12cm]{tex/img/ch05/VERE_Viewer_01.png}
\captionof{figure}{The viewer-application overlaying regions}
