...
\begin{wrapfigure}{l}{0.45\textwidth}
    \begin{center}
    \includegraphics[width=0.44\textwidth]{tex/img/ch04/ActivityDiagram_HighLevel01.png}
    \end{center}
