...
%  \immediate\write18{texcount -merge -sum -incbib -dir="./tex" #1.tex > #1.wcdetail }%
%  \verbatiminput{#1.wcdetail}%
%}
 
%\newcommand{\quickwordcount}[1]{%
%  \immediate\write18{texcount -1 -sum -merge -dir="./tex" #1.tex > #1-words.sum }%
%  \input{#1-words.sum} words%
%}
 
%\newcommand{\quickcharcount}[1]{%
%  \immediate\write18{texcount -1 -sum -merge -char -dir="./tex" #1.tex > #1-chars.sum }%
