...
\chapter{Algorithms}
\input{src/pseudo-automatic-mode.tex}

\input{src/pseudo-raycast-screen.tex}
...
%\begin{listing}[ht]
    ...
    \captionof{figure}{The generated meta file to \ref{fig:output-image} (shortened)}
...
%\begin{listing}[ht]
    ...
    \captionof{figure}{The generated text file to \ref{fig:output-image} for use with the \textit{"Darknet"} framework}
